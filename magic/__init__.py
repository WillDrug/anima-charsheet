...
class MagicConfig(ModuleConfig):
    def __init__(self, zeon_cost, ma_multiple_cost, mp_cost, summon_cost, control_cost, bind_cost, banish_cost,
                 summon_per_level, control_per_level, bind_per_level, banish_per_level, **kwargs):
...
class Magic(Module):
    def __init__(self, *args, **kwargs):
        ...
        self.magic_accumulation.add_bonus(*self.config.character.general.stats.get('INT').magic_level_bonus())
        ...
        self.zeon_regeneration.add_bonus(*self.config.character.general.stats.get('POW').magic_accum_bonus())
